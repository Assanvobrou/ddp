    ...
    <div className="min-h-screen flex bg-surface-100">
      ...
      <div className="hidden lg:flex w-[440px] flex-shrink-0 bg-primary-600 flex-col p-12 relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center z-10 text-center">
          ...
          <div className="text-white text-[18px] font-black tracking-tight">Maternité Rahama</div>
          <div className="text-white/50 text-[9px] font-bold tracking-[0.9px] uppercase mt-1">Système de gestion clinique</div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-[400px] bg-white rounded-2xl border border-surface-200 shadow-card p-9 animate-fade-up">
          ...
          <div className="flex lg:hidden items-center gap-2.5 mb-6">
            <img src="/logo_2.png" alt="Logo" className="h-10 w-10 object-contain rounded-xl"
              onError={(e) => { (e.target as HTMLImageElement).style.display='none' }} />
            <div>
